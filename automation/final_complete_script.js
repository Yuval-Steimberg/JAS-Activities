/**
 * COMPLETE GOOGLE APPS SCRIPT - FINAL VERSION
 * 
 * This script does EVERYTHING:
 * 1. Saves form data to Google Sheets
 * 2. Sends admin email with summary
 * 3. Sends customer ONE email with summary + PDF invoice attached
 * 
 * REPLACES ALL YOUR EXISTING CODE
 */
...
function doPost(e) {
  try {
    ...
    Logger.log('p.contact_email value: "' + p.contact_email + '"');
    Logger.log('Type: ' + typeof p.contact_email);
    ...
    if (p.contact_email) {
      ...
      Logger.log('Form data received: ' + JSON.stringify(p));
    }
