...
// Redirect URLs
var HOME_URL = 'http://localhost:8081/index.html';
var SUCCESS_URL = 'http://localhost:8081/success.html';
...
function doPost(e) {
  try {
    ...
    var successHtml = '<html><head><meta http-equiv="refresh" content="0; url=\'' + SUCCESS_URL + '\'"/></head><body>Redirecting...</body></html>';
